...
class $30679d0190398326$export$2e2bcd8739ae039 extends ( 0,
$bf0d59a2e36aadbf$export$2e2bcd8739ae039 ) {
	constructor() {
		super();
	}
	/**
 ...
 */ class $82cbb5a2f3a1bcd0$var$LiteVimeo extends ( 0,
$30679d0190398326$export$2e2bcd8739ae039 ) {
	constructor() {
		super();
		this.setupDom();
	}
	 ...
	 */ initImagePlaceholder = async () => {
		...
		$82cbb5a2f3a1bcd0$var$LiteVimeo.preconnected ||
			$82cbb5a2f3a1bcd0$var$LiteVimeo.addPrefetch(
				'preconnect',
	 ...
	 */ static warmConnections() {
		...
		Object.entries( vimeoAssets ).forEach( ( [ kind, urls ] ) => {
			urls.forEach( ( url ) =>
				$82cbb5a2f3a1bcd0$var$LiteVimeo.addPrefetch( kind, url )
			);
		} );
